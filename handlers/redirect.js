...
exports.handler = async () => {
    ...
    const {
        CLIENT_ID
    } = JSON.parse(SecretString) // SecretString stores our values as a string so we need to transform it into an object to make it easier to work with
    ...
    return {
        ...
        headers: {
            Location
        } // "Location" header sets redirect location
    }
}